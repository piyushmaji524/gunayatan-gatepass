...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['action'])) {    if ($_POST['action'] === 'verify') {        
        ...
        if ($stmt->affected_rows > 0) {
            ...
            try {
                ...
                sendInstantNotification('gatepass_verified', $gatepass['id'], $gatepass['gatepass_number'], $gatepass['created_by'], $_SESSION['user_id']);
            } catch (Exception $e) {
                // Log the error but don't stop the process
                error_log("Notification error: " . $e->getMessage());
            }
            
            // Redirect to dashboard with success message and specify show_popup parameter
            redirectWithMessage("dashboard.php", "Gatepass #" . $gatepass['gatepass_number'] . " verified successfully", "success", true);
        } else {
            // If update failed
