                ...
                <div class="card-body">
                    ...
                    <form method="post" action="profile.php">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="role" value="<?php echo ucfirst(htmlspecialchars($user['role'])); ?>" readonly disabled>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="created_at" value="<?php echo date('d M Y H:i', strtotime($user['created_at'])); ?>" readonly disabled>
                        </div>
